...
export function setupDusk()
{
    ...
    // Setup D&D skills.
    c.dSkills.setSkillProficiency(DSkill.Persuasion, Hidden, ProficiencyLevel.None, -5);
    c.dSkills.setSkillProficiency(DSkill.Deception, Hidden, ProficiencyLevel.Half);
    c.dSkills.setSkillProficiency(DSkill.Perception, Hidden, ProficiencyLevel.Half);
    c.dSkills.setSkillProficiency(DSkill.Stealth, Hidden, ProficiencyLevel.Half);
    c.dSkills.setSkillProficiency(DSkill.History, Hidden, ProficiencyLevel.Prof);
    c.dSkills.setSkillProficiency(DSkill.Insight, Hidden, ProficiencyLevel.Prof);
