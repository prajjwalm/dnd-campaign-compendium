...
export function session7NpcInteractions(
    npcInteractionEvents: Map<NpcId, Map<PcIndex, NpcOpinionV2>>)
{
    ...
    npcInteractionEvents.get(NpcId.Roberta).get(PcIndex.ID_AURELIA).addEvent(
        new NpcInteractionEvent(
            new GameTimestamp(0, 6, 8, 0),
    ...
    npcInteractionEvents.get(NpcId.Vitacia).get(PcIndex.ID_CYRION).addEvent(
        new NpcInteractionEvent(
            new GameTimestamp(0, 6, 8, 15),
                      ...
                      PcIndex.ID_AURELIA])
    {
        npcInteractionEvents.get(NpcId.Vitacia).get(pc).addEvent(
            new NpcInteractionEvent(
                ...
                "it.",
                new Map([
                    [PositiveEmotion.Respect, pc == PcIndex.ID_CYRION ? 6 : 1],
                    [PositiveEmotion.Trust, pc == PcIndex.ID_CYRION ? 5 : 1],
                    [PositiveEmotion.Affection, pc == PcIndex.ID_CYRION ? 8 : 2]
                ]),
                10,
                new Map([
                    [PositiveEmotion.Affection, pc == PcIndex.ID_CYRION],
                    [PositiveEmotion.Respect, true],
                    [PositiveEmotion.Trust, true],
                ])
            )
    ...
    npcInteractionEvents.get(NpcId.Yuki).get(PcIndex.ID_HELIOS).addEvent(
        new NpcInteractionEvent(
            ...
            NpcIndex.get(NpcId.Yuki).passiveDeception + 5
        )
    );
    ...
    npcInteractionEvents.get(NpcId.Genefe).get(PcIndex.ID_HELIOS).addEvent(
        new NpcInteractionEvent(
            new GameTimestamp(0, 6, 9, 30),
    ...
    npcInteractionEvents.get(NpcId.Cecelia).get(PcIndex.ID_HELIOS).addEvent(
        new NpcInteractionEvent(
            ...
            NpcIndex.get(NpcId.Cecelia).passiveDeception + 5,
